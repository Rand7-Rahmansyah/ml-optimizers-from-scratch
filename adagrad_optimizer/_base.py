    ...
    * Private helpers        → nama dengan leading underscore (``_sigmoid``)
    ...
    def __init__(
        ...
        *,
        ...
        # di sini; transformasi dilakukan di fit().
        self.loss = loss
        self.lr = lr
        self.epochs = epochs
    ...
    # ------------------------------------------------------------------
    # Abstract interface — wajib diimplementasikan oleh subclass
    # ------------------------------------------------------------------
    ...
    def _check_is_fitted(self) -> None:
        """
        Pastikan fit() sudah dipanggil sebelum predict/predict_proba.
